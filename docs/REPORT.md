...
> *[[Video demostracion funcionalidades](https://drive.google.com/file/d/1rZMVgUXCdcsQhk4vey-n839pQQS4iQqD/view?usp=sharing)]*

> *[[Aplicación .apk instalar](https://drive.google.com/file/d/1ZuMgbij0S6mLsejOGfY8VdffE9wpE08X/view?usp=sharing)]*
...
|:---:|:---:|
| <img src="media/figure1.jpg" height="400" alt="Feed Comparison"> | <img src="media/figure2.jpg" height="400" alt="Sync Indicators"> |
| *Adaptive OLED Dark Mode* | *Orange (Pending) vs Green (Synced)* |

| **Interactions: Likes & Saved** | **Hybrid Image Rendering** |
|:---:|:---:|
| <img src="media/figure3.jpg" height="400" alt="Interactions"> | <img src="media/figure4.jpg" height="400" alt="Article Detail"> |
| *Persisted State across App Restarts* | *Local File vs Remote URL* |

| **Create & Edit Reports** | **Profile & Theming** |
|:---:|:---:|
| <img src="media/figure5.jpg" height="400" alt="Create Screen"> | <img src="media/figure6.jpg" height="400" alt="Profile Screen"> |
| *Form Validation & Image Picker* | *Theme Switcher & Logout* |

| **Login Screen** | **Register Screen** |
|:---:|:---:|
| <img src="media/figure7.jpg" height="400" alt="Login Screen"> | <img src="media/figure8.jpg" height="400" alt="Register Screen"> |
| *Secure Authentication Flow* | *New User Registration* |
